...
class ect_calendar_template{
	...
	*/
	function ect_register_script(){
		wp_register_script('ect-moment', ECT_PLUGIN_URL.'assets/js/moment.min.js',null,ECT_VERSION_CURRENT,false);
		wp_register_script('ect-code-snippet', ECT_PLUGIN_URL.'assets/js/tui-code-snippet.js',null,ECT_VERSION_CURRENT,false);
		wp_register_script('ect-calendar', ECT_PLUGIN_URL.'assets/js/calendar.js',null,ECT_VERSION_CURRENT,false);
		wp_register_style('ect_calendar-style', ECT_PLUGIN_URL. 'assets/css/tui-calendar.css', array(), ECT_VERSION_CURRENT, 'all');
		wp_register_style('ect-common-styles', ECT_PLUGIN_URL. 'assets/css/ect-common-styles.css', array(), ECT_VERSION_CURRENT, 'all');
		wp_register_style('ect_custom-style', ECT_PLUGIN_URL. 'assets/css/ect-custom-calendar.css', array(), ECT_VERSION_CURRENT, 'all');
		wp_register_script('ect_custom', ECT_PLUGIN_URL. 'assets/js/ect-custom-calendar.js', array('jquery','wp-api-request'), ECT_VERSION_CURRENT, true);
	...
	*/
	public function ect_calendar_shortcode( $attr, $content=null){
	  ...
	  <div class="ect_calendar_events_spinner"><img src="'.ECT_PLUGIN_URL .'assets/images/ect-preloader.gif"></div>
    ...
    */
	...
	function event_category_add_style( $term ){
		...
		<div class="form-field">
			Background Color <input name="_event_bgColor" value="#f5f5f5" class="colorpicker" id="term-colorpicker" />
			Text Color <input name="_event_textColor" value="#ffffff" class="colorpicker" id="term-colorpicker" />
		</div>
		<?php
		}else{
