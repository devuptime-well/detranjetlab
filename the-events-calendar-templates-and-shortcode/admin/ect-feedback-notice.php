...
if (!class_exists('ECTProFeedbackNotice')) {
	...
	public function load_script() {
		wp_register_script( 'ect-feedback-notice-script', ECT_PLUGIN_URL. 'assets/js/ect-admin-feedback-notice.js', array( 'jquery' ),null, true );
        wp_enqueue_script( 'ect-feedback-notice-script' );
        wp_register_style( 'ect-feedback-notice-styles',ECT_PLUGIN_URL.'assets/css/ect-admin-feedback-notice.css' );
    ...
    public function admin_notice_for_reviews(){
       ...
       function create_notice_content(){
        ...
        <ul>
            ...
            <li class="close_it"><a href="javascript:void(0);" class="close_rating_box ect_dismiss_notice">%10$s</a></li>
        </ul>
