jQuery(document).ready(function ($){
	const catsEndPoint=ectRestUrl+'categories'+'/?per_page=25';
	const tagsEndPoint=ectRestUrl+'tags'+'/?per_page=25';
	const venuesEndPoint=ectRestUrl+'venues'+'/?per_page=25&status=publish';
	const organizersEndPoint=ectRestUrl+'organizers'+'/?per_page=25&status=publish';
	 let categoryList = [];
	 let tagList=[];
	 let venueList=[];
	 let organizerList=[];
