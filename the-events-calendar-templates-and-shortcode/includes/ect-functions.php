<?php 
    ...
    function ect_styles() {
        wp_register_style('ect-common-styles', ECT_PLUGIN_URL . 'assets/css/ect-common-styles.min.css',null, null,'all' );	
         wp_register_style('ect-timeline-view-styles', ECT_PLUGIN_URL . 'assets/css/ect-timeline-view.min.css',null, null,'all' );	
         wp_register_style('ect-list-view-styles', ECT_PLUGIN_URL . 'assets/css/ect-list-view.min.css',null, null,'all' );	
         wp_register_style('ect-grid-view-styles', ECT_PLUGIN_URL . 'assets/css/ect-grid-view.min.css',null, null,'all' );
        wp_register_style('ect-carousel-view-styles', ECT_PLUGIN_URL . 'assets/css/ect-carousel-view.min.css',null, null,'all' );
        wp_register_style('ect-slider-view-styles', ECT_PLUGIN_URL . 'assets/css/ect-slider-view.min.css',null, null,'all' );
        wp_register_style('ect-accordion-view-styles', ECT_PLUGIN_URL . 'assets/css/ect-accordion-view.min.css',null, null,'all' );

        wp_register_style('ect-grid-view-bootstrap', ECT_PLUGIN_URL . 'assets/css/bootstrap.min.css',null, null,'all' );
        wp_register_style('ect-slider-slick', ECT_PLUGIN_URL . 'assets/css/slick.min.css',null, null,'all' );
        wp_register_style('ect-collapse-bootstrap', ECT_PLUGIN_URL . 'assets/css/collapse-bootstrap-4.0.min.css',null, null,'all' );
                
        wp_register_script('ect-accordion-view-js', ECT_PLUGIN_URL . 'assets/js/ect-accordion-view.min.js',array('jquery'),null,true);
        wp_register_script( 'ect-slider-slick-js', ECT_PLUGIN_URL . 'assets/js/slick.min.js',array('jquery'),null,true);
        
        // mansory layout scripts
        wp_register_script('imagesloaded', ECT_PLUGIN_URL . 'assets/js/imagesloaded.pkgd.min.js');
        wp_register_script('masonry-lib', ECT_PLUGIN_URL . 'assets/js/masonry-3.1.4.js',array('jquery'),null,true);
        wp_register_script('masonry.filter', ECT_PLUGIN_URL . 'assets/js/masonry.filter.js',array('jquery','masonry-lib'),null,true);
        wp_register_script('ect-masonry-js', ECT_PLUGIN_URL . 'assets/js/ect-masonry.min.js',array('jquery','masonry-lib','masonry.filter','imagesloaded'),null,true);

        //like and share style and script	
        wp_register_script('ect-events_data',ECT_PLUGIN_URL .'assets/js/ect-sendajax-request.min.js',array('jquery'),null,true);
        wp_register_script('ect-sharebutton',ECT_PLUGIN_URL .'assets/js/ect-sharebutton.js',array('jquery'),null,true);
        

        wp_register_script('ect-common-scripts',ECT_PLUGIN_URL .'assets/js/ect.min.js',array('jquery'),null,true);
    }
